      ...
      .pipe(
        purgecss({
          content: [
            ...
            whitelist: ['dropdown-sub', 'nav-link', 'alignleft', 'alignright', 'aligncenter', 'opened', 'search-form', 'search-submit', 'error404', 'content', 'frm_primary_label', 'aos-animate', 'aos-init', '[data-aos]', 'data-aos', 'animated', '[data-aos-easing=ease]', 'data-aos-easing=ease', '[data-aos=fade-up]', '[data-aos=fade-right]', '[data-aos=fade-left]', 'frm_button_submit', 'collapsing', 'recent-posts-3', 'menu-our-services-footer', 'post-date']
        })
      )
      .pipe(gulp.dest(dist.css))
